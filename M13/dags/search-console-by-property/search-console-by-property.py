    ...
    if account == "Account1":
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account1-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account5-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account2-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account3-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account4-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account7-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account8-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account9-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account10-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account11-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-property-account6-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
