    ...
    if account == "Account1":
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account1-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account5-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account2-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account3-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account4-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account7-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account8-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account9-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account10-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account11-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-query-account6-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
