    ...
    if account == "Account1":
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account1-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account5-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account2-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account3-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account4-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account7-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account8-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account9-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account10-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account11-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
        ...
        account_env_vars.extend(
            [
                k8s.V1EnvVar(
                    name="BQ_TABLE_GSC",
                    value="{{ var.value.get('search-console-by-page-account6-bq-table') }}",
                ),
                k8s.V1EnvVar(
                    name="GSC_SA",
