...
with models.DAG(
    dag_id="extract-analytics-platform-data",
    description="Loads data from AnalyticsPlatform API at regular intervals.",
    schedule_interval="20 6-20 * * *",
    ...
    for account in accounts:
        with TaskGroup(group_id=f"{account}") as account_group:
            ...
            _ = KubernetesPodOperator(
                ...
                image="{{ var.value.get('ARTIFACT_REGISTRY_REPOSITORY') }}/extract-analytics-platform-data:latest",
